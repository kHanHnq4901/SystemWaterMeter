...
const columns: TableColumnList = [
  ...
  { label: "Mã Gateway", prop: "code", width: 120 },
  { label: "Tên Gateway", prop: "name", minWidth: 180 },
  {
    label: "Khu vực",
    prop: "area",
    width: 120,
  ...
  { label: "Tín hiệu (dBm)", prop: "signal", width: 110 },
...
function getSignalColor(signal: number) {
  return signal > -70 ? "#10b981" : signal > -85 ? "#f59e0b" : "#ef4444";
}
...
<template>
  <div class="gateway-container">
    ...
    >
      <el-form-item label="Mã Gateway:" prop="code">
        <el-input
          v-model="form.code"
          placeholder="Nhập mã Gateway"
          clearable
          class="w-44!"
        />
      </el-form-item>
    ...
    >
      ...
      <template #default>
        ...
        >
          ...
          <template #signal="{ row }">
            <span :style="{ color: getSignalColor(row.signal) }">{{
              row.signal
            }}</span>
          </template>
